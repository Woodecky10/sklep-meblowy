...
export const pl = {
  ...
  reviewsPage: {
    ...
    intro:
      "Publikujemy tylko opinie osób, które kupiły u nas mebel — zaproszenie do wystawienia opinii wysyłamy po dostawie, na adres z zamówienia. Opinia pojawia się od razu; sprawdzamy ją po publikacji i usuwamy wyłącznie spam oraz treści obraźliwe. Nie usuwamy opinii krytycznych i nie zmieniamy ich treści.",
    metaDescription:
