...
export const de: DeepPartial<PlShape> = {
  ...
  shop: {
    ...
    correctedShowing: "Wir zeigen Ergebnisse für",
    correctedNotFound: "nichts gefunden für",
  ...
  a11y: {
    ...
    prevCollections: "Vorherige Kollektionen",
    nextCollections: "Nächste Kollektionen",
    prevBundles: "Vorherige Sets",
    nextBundles: "Nächste Sets",
    goToSlide: "Zu Slide",
