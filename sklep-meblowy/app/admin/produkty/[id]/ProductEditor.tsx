...
export default function ProductEditor({
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      {/* ============================================================
          Sekcja: Warianty — placeholder dla 17d
          ============================================================ */}
      {hasVariants(product) && (
        <section className="bg-[var(--card-bg)] border border-[var(--border)] rounded-2xl p-6">
          <h2 className="font-display text-xl font-semibold text-[var(--fg)]">
            Warianty produktu ({product.variants!.combinations.length})
          </h2>
          <p className="text-sm text-[var(--muted)] mt-2">
            Edytor wariantów (cena, stock, zdjęcia per kombinacja) pojawi się w kolejnym kroku (17d).
          </p>
        </section>
      )}
    </div>
